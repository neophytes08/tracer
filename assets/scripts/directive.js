		...
		.directive('list', [
			function directive(){
				return {
					...
					"templateUrl": "/tracer/assets/template/list.html",
		...
		.directive('add', [
			function directive(){
				return {
					...
					"templateUrl": "/tracer/assets/template/add.html",
					"link": function onlink(scope, element, attributeSet){
						element.addClass("hidden");
						scope.$on('show-add' , 
						function on(){
		...
		.directive('dashboard', [
			function directive(){
				return {
					...
					"templateUrl": "/tracer/assets/template/dashboard.html",
					"link": function onLink(scope, element, attributeSet){
						element.addClass("hidden");
		...
		.directive('statistics', [
			function directive(){
				return {
					...
					"templateUrl": "/tracer/assets/template/statistical.html",
					"link": function onlink(scope, element, attributeSet){
						element.addClass("hidden");
		...
		.directive('settings', [
			function directive(){
				return {
					...
					"templateUrl": "/tracer/assets/template/settings.html",
					"link": function onlink(scope, element, attributeSet){
						// element.addClass("hidden");
